    ...
    <div className="bg-gray-100 bg-opacity-70 fixed inset-0 flex justify-center items-center z-50">
      <div id="popup-modal" className="relative rounded-lg shadow bg-gray-700">
        <button
          onClick={onClose}
          type="button"
          className="transition duration-300 transform hover:scale-105 absolute top-3 right-2.5 text-gray-400 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center hover:bg-gray-600 hover:text-white"
        >
          <svg
            className="w-3 h-3"
            aria-hidden="true"
        ...
        <div className="p-6 text-center">
          ...
          <button
            onClick={onClose}
            type="button"
            className="transition duration-300 transform hover:scale-105 text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"
          >
            No, cancelar
          </button>
        </div>
